...
public class MainActivity extends AppCompatActivity {
    ...
    private void addSampleLectures() {
        lectures.add(new Lecture("Laba_1", "1C", 3));
        lectures.add(new Lecture("Laba_2", "1C", 3));
        lectures.add(new Lecture("Laba_3", "1C", 3));
    }
    ...
    private void loadLecturesFromApi() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                connection.setConnectTimeout(5000); // Устанавливаем таймаут на подключение
                connection.setReadTimeout(5000);    // Устанавливаем таймаут на чтение
